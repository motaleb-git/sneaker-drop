-- Reference schema. Versioned migrations in server/src/db/migrations/ are applied on boot.
...
CREATE INDEX IF NOT EXISTS drops_starts_ends_idx ON drops (starts_at, ends_at);
